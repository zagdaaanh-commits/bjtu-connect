            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  placeholder="e.g. Tue & Thu 14:00 - 17:00"
                  className="w-full text-xs sm:text-sm px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-academic-600/20 focus:border-academic-700 outline-none"
                />
                <div className="flex flex-wrap gap-1.5 mt-1.5">
                  {['Tue & Thu 14:00 - 17:00', 'Mon & Wed 09:30 - 11:30', 'Wed & Fri 15:00 - 17:30'].map((preset) => (
                    <button
                      key={preset}
                      type="button"
                      onClick={() => setOfficeHours(preset)}
                      className="text-[10px] px-2 py-0.5 rounded-md bg-slate-100 hover:bg-academic-50 hover:text-academic-700 text-slate-600 transition-colors cursor-pointer"
                    >
                      {preset}
                    </button>
                  ))}
